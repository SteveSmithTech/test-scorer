...
public final class TestTest {
    private static final Test TEST_0900 = new Test("R1", of(2018, JANUARY, 1, 9, 0), SUCCESS);
    private static final Test TEST_1000 = new Test("R2", of(2018, JANUARY, 1, 10, 0), SUCCESS);
    private static final Test TEST_1100 = new Test("R3", of(2018, JANUARY, 1, 11, 0), SUCCESS);
