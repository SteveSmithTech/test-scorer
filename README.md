...
[![Build Status](https://travis-ci.org/SteveSmithCD/hmrc.svg?branch=master)](https://travis-ci.org/SteveSmithCD/test-scorer) [ ![Download](https://api.bintray.com/packages/SteveSmithCD/releases/test-scorer/images/download.svg) ](https://bintray.com/SteveSmithCD/releases/test-scorer/_latestVersion)
